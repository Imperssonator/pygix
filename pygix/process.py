...
class Processor(object):
    ...
    def __init__(self, yaml_file):
        ...
        self.reduction = list(reduction.keys())[0]
    ...
    def _process1d(self):
        ...
        print(msg.format(n_files, t_end, old_div(t_end,n_files)))
